...
## 📁 ساختار پوشه‌بندی و ماژول‌ها (Project Structure)

ساختار مخزن به صورت تفکیک‌شده، ماژولار و استاندارد سازمان‌دهی شده است:

```text
prometheusopenbot/
├── bot.py                     # نقطه ورود و راه‌انداز اصلی سرور و ربات تلگرام
├── requirements.txt           # وابستگی‌ها و پکیج‌های پایتون
├── .env.example               # الگوی متغیرهای محیطی و تنظیمات
├── nixpacks.toml / railway.json # پیکربندی استقرار ابری (Railway / Nixpacks)
│
├── src/                       # هسته اصلی و پکیج‌های کاربردی
│   ├── core/                  # ارتباطات پایگاه داده، هوش مصنوعی، کلاینت HTTP و پیکربندی
│   │   ├── ai_service.py      # سرویس یکپارچه LLM، کنترل پرامپت، پردازش تصویر و ابزارها
...
│   │   ├── files/             # تولید و استخراج اسناد (PDF, Word, Excel, CSV)
│   │   ├── financial/         # استعلام لحظه‌ای کریپتو، طلا، ارز و فارکس
│   │   ├── github/            # تعامل تخصصی با مخازن و ایشوهای گیت‌هاب
...
│   └── utils/                 # فرمت‌بندی تلگرام، پاک‌سازی خروجی‌ها و تایپوگرافی
│
...
│   ├── test_financial_scientific_suite.py # آزمون ابزارهای مالی و محاسباتی
│   ├── test_media_files_runner.py        # آزمون پردازش اسناد، مدیا و تصویر
│   └── test_rigorous_battery.py          # ارزیابی شرایط مرزی و ورودی‌های نامتعارف
│
└── assets/                    # دارایی‌های استاتیک و فونت‌های استاندارد فارسی
```
